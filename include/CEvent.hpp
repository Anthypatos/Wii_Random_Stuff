...
class CEvent 
{
    public:
        ...
        virtual void OnLButtonDown(Sint32 iMouseX, Sint32 iMouseY) = 0;
        virtual void OnLButtonUp(Sint32 iMouseX, Sint32 iMouseY) = 0;
        virtual void OnRButtonDown(Sint32 iMouseX, Sint32 iMouseY) = 0;
        virtual void OnRButtonUp(Sint32 iMouseX, Sint32 iMouseY) = 0;
        virtual void OnMButtonDown(Sint32 iMouseX, Sint32 iMouseY) = 0;
        virtual void OnMButtonUp(Sint32 iMouseX, Sint32 iMouseY) = 0;
        ...
        virtual void OnJoyBall(Uint8 yWhich, Uint8 yBall, Sint16 rRelX, Sint16 rRelY) = 0;
